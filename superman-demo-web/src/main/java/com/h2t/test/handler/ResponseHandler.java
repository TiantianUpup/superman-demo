package com.h2t.test.handler;

import com.h2t.test.exception.CustomException;
...
public class ResponseHandler {
    private static Logger logger = LoggerFactory.getLogger(com.h2t.test.handler.ResponseHandler.class);

    @ExceptionHandler({com.h2t.test.exception.CustomException.class})
